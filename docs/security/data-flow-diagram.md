...
- Boundary 2: Backend to third-party AI provider
  Prompt content built from user responses is sent to OpenRouter for the configured OpenAI model.
...
- OpenRouter integration: [services.py](/Users/devanshijain/SBDC/services.py:36)
